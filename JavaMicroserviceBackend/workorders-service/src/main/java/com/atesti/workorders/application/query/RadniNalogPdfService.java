...
public class RadniNalogPdfService {
    ...
    private byte[] buildPdfBuffer(RadniNalog nalog, LocalNarucitelj narucitelj, List<String> aktivnosti) {
        ...
        Paragraph subtitle = new Paragraph(
                "ZASTITA NA RADU, ZASTITA OD POZARA, TEHNICKO SAVJETOVANJE I MINIMALNI TEHNICKI UVJETI",
                subtitleFont);
        ...
        addLabeledRow(document, "Narucitelj", narucitelj != null ? narucitelj.getName() : "", labelFont, valueNameFont);
        addLabeledRow(document, "Adresa narucitelja", joinAddress(narucitelj), labelFont, valueFont);
        ...
        addLabeledRow(document, "Narudzbenica", nalog.getNarudzbenica(), labelFont, valueFont);
        addLabeledRow(document, "Broj racuna", nalog.getBrojRacuna(), labelFont, valueFont);
    ...
    private List<String> resolveAktivnosti(String aktivnostiJson) {
        ...
        try {
            ...
            if (!numericIds.isEmpty()) {
                List<LocalAktivnost> configs = localAktivnostRepository.findByIdInAndIsActiveTrue(numericIds);
                Map<Long, String> configById = configs.stream()
                        .collect(Collectors.toMap(LocalAktivnost::getId, LocalAktivnost::getAktivnost));
    ...
    private String joinAddress(LocalNarucitelj narucitelj) {
